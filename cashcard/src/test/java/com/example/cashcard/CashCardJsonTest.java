...
@JsonTest
// Test class using Jackson Framework
public class CashCardJsonTest {

    @Autowired
//  direct spring to create object of requested type when necessary
    ...
    void cashCardListDeserializationTest() throws IOException {
        String expected="""
            [
                { "id": 99, "amount": 123.45, "cardOwner": "sarah1" },
                { "id": 100, "amount": 1.00, "cardOwner": "sarah1" },
                { "id": 101, "amount": 150.00, "cardOwner": "sarah1" }
            ]
        """;
